...
const Footer = () => {
    return (
        <div>
            ...
            <footer className="footer  bg-slate-700 text-white px-10 py-4 border-t   border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>All right reserved by Chamok barmon <br />Providing reliable tech since 2022</p>
                </div>
